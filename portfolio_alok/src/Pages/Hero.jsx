...
export default function PortfolioOne() {
  ...
  const [activeProjectCategory,setProjectCategory] = useState("full-stack")
  ...
  const skillCategories = [
    ...
    {id:"generative_ai",name:"Gen AI",icon:Code}
  ]
    const projectCategories = [
    { id: "frontend", name: "Frontend", icon: Palette },
    { id: "full-stack", name: "Full Stack", icon: Server },
    { id: "gen-ai", name: "GEN AI", icon:Code },
